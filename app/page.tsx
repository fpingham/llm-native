  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-black/95 backdrop-blur-sm">
            <div className="px-4 py-4 space-y-3">
              <Link 
                href="/events"
                className="block mt-4 px-4 py-2 bg-white text-black rounded-full text-center hover:bg-gray-100 transition-colors"
              >
                View Events
              </Link>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12">
        ...
        <main>
          <section id="manifesto" className="bg-gray-950/30 backdrop-blur-sm border border-gray-900/50 rounded-lg p-8 mb-8">
          ...
          <section className="text-center">
            <a 
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-[#5865F2] hover:bg-[#4752C4] text-white rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              target="_blank"
